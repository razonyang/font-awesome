...
t = function() {
    ...
    let b = "fa-kits-diag", w = "fa-kits-node-under-test", y = "data-md5", v = "data-fa-detection-ignore", A = "data-fa-detection-timeout", x = "data-fa-detection-results-collection-max-wait", T = t => {
    ...
    function O(t) {
        ...
        var t = (e => {
            ...
            function o(t, e) {
                ...
                let r = l.createElement("i"), a = (r.setAttribute("class", "fa fa-coffee"), 
